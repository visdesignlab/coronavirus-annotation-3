...
export let segData = [
  ...
  {class: 'sec-three', 
  stills:'flatImages', 
  group: 3, name: 'Transcription Overview', id : 3, 
  frames:[8036, 11245], range:[268,375], 
  annotations: 'Annotation_Ann.csv', 
  structure_data:'stuctured_structures_seg3.csv'},
  // section 4 (transcription, hypothesis 1): frames 11246 - 13106
  {class: 'sec-four', 
  stills:'flatImages', 
  group: 4, name: 'Transcription, Hypothesis 1', id : 4, frames:[11246, 13106], range:[376,438], 
  annotations: 'Annotation_Ann.csv', 
  structure_data:'stuctured_structure_data.csv'},

...
export let segData = [
  ...
  {class: 'sec-two', stills:'sec2_8035', group: 2, name: 'Early Translation', id : 2, frames:[2601, 8035], range:[93,267], annotations: 'Annotation_Margot.csv', structure_data:'stuctured_structures_seg2.csv'},
...
export function formatTime(timeInSeconds) {
  console.log('formatting time', timeInSeconds);
